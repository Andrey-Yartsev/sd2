<? if (Auth::get('id')) { ?>
<a href="/interviews" class="btn btnGreen"><span>Мои опросы <small>(<?= UsersCore::getTitle(Auth::get('id')) ?>)</small></span></a>
<a href="?logout=1" class="login">Выйти</a>
<? } else { ?>
<a href="" class="btn btnGreen try"><span>Попробовать</span></a>
